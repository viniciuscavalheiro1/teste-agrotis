...
public class FazendaRs {
    ...
    public static FazendaRs converter(Fazenda f) {
        var fazenda = new FazendaRs();
        fazenda.setId(f.getId());
        fazenda.setData_inicial(f.getData_inicial());
        fazenda.setData_final(f.getData_final());
        fazenda.setId_propriedade_fazenda(f.getId_propriedade_fazenda());
        fazenda.setCnpj(f.getCnpj());
        fazenda.setId_laboratorio(f.getId_laboratorio());
        fazenda.setObservacoes(f.getObservacoes());
        return fazenda;
    }
